 ...
 @section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <a href="{{route('banner.index')}}"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"> Back</i></a>
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Edit Banner</h4><hr/>
            ...
            <form class="forms-sample" action="{{route('banner.update', $banner->id)}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" value="{{$banner->title}}" placeholder="Title" name="title">
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Description</label>
                <textarea class="form-control" id="description" placeholder="Description" name="description">{{$banner->description}}</textarea>
              </div>
                ...
                <div class="form-group col-md-6">
                  <label for="exampleInputPassword1">Upload Banner</label>
                    <div class="input-group">
                      ...
                      <input id="thumbnail" class="form-control input-sm" type="text" name="photo" id="photo" value="{{$banner->photo}}">
                    </div>
