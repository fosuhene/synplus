      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <!--Section: Accordion-->
<section class="mb-5">
    <form class="forms-sample" action="{{route('product.update', $category->id)}}" method="POST">
        @csrf
    <!--Accordion wrapper-->
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control"  col="5" rows="3" id="summary" placeholder="Product Summary" name="summary">{{$product->summary}}</textarea>
              </div>
              <div class="form-group">
        ...
        <div id="collapseStock" class="collapse" role="tabpanel" aria-labelledby="pStock">
          <div class="card-body">
             <div class="form-group">
                ...
                <input type="text" step="any" class="form-control" id="available_qty" value="{{$product->available_qty}}" placeholder="Stock" name="available_qty">
              </div>
              <div class="row">
                ...
                <input type="text" step="any" class="form-control" id="cost_price" value="{{$product->cost_price}}" placeholder="Cost Price" name="cost_price">
              </div>
              <div class="form-group col-md-6 col-sm-6 col-lg-6">
                ...
                <input type="text" step="any" class="form-control" id="markup_price" value="{{$product->markup_price}}" placeholder="Markup Price" name="markup_price">
              </div>
            </div>
              <div class="row">
              <div class="form-group col-md-6 col-sm-6 col-lg-6">
                ...
                <input type="text" step="any" class="form-control" id="unit_cost" value="{{$product->unit_cost}}" placeholder="Unit Cost" name="unit_cost">
              </div>
              <div class="form-group col-md-6 col-sm-6 col-lg-6">
                ...
                <input type="text" step="any" class="form-control" id="unit_price" value="{{$product->unit_price}}" placeholder="Unit Price" name="unit_price">
              </div>
            </div> 
            <div class="form-group">
              ...
              <input type="text" step="any" class="form-control" id="discount" value="{{$product->discount}}" placeholder="Eg: 2" name="discount">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input id="thumbnail" class="form-control input-sm" type="text" name="photo" id="photo" value="{{$product->photo}}">
              </div>
                ...
                <label for="">Size <span class="text-danger">*</span></label>
                  <select name="item_size" id="item_size"  class="form-control show-tick text-black">
                    <option value="">-- Size --</option>
                        <option value="S" {{$product->item_size == 'S' ? 'selected' : ''}}>S</option>
                        <option value="M" {{$product->item_size == 'M' ? 'selected' : ''}}>M</option>
                        <option value="L" {{$product->item_size == 'L' ? 'selected' : ''}}>L</option>
                        <option value="XL" {{$product->item_size == 'XL' ? 'selected' : ''}}>XL</option>
                        <option value="XXL" {{$product->item_size == 'XXL' ? 'selected' : ''}}>XXL</option>
                  </select>
              </div>
